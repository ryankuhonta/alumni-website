    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <input
          ...
          className="flex-1 border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
        {activeRole !== 'teacher' && (
          <input
            type="number"
            ...
            onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
            className="w-32 border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
        )}
        <button
